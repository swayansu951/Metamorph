...
import faiss
import numpy as np
from backend.retrievals.simple_rag.database.embedder import embed_model
from backend.retrievals.simple_rag.database.load_pdf import extract_load_pdf
from backend.retrievals.simple_rag.database.semantic_chunker import semantic_chunker
