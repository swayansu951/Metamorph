...
import re
import requests
from backend.retrievals.simple_rag.main import GENERATE
from typing import TypedDict, Optional
from langchain_ollama import ChatOllama
from backend.tool.web_scraping.web_rag_pipeline import PIPELINE
from langgraph.graph.message import add_messages
from langgraph.graph import StateGraph,END,START
from typing import TypedDict, Annotated , Sequence
from backend.tool.duckduckgo import safe_search, news_search, search_media
...
async def _run_web_pipeline(query: str) -> str:
    ...
    from backend.tool.webscraping import run_pipeline
